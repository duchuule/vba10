...
//code from https://github.com/libretro/common-shaders/blob/master/xbr/shaders/legacy/5xbr-v4.0-noblend.cg
...
float4 main(in PSIn VAR) : SV_TARGET0
{
	...
	float4 dist1 = weighted_distance(e, c, g, i, h5, f4, h, f);
	float4 dist2 = weighted_distance(h, d, i5, f, i4, b, e, i);
	edr = (dist1 < dist2) && interp_restriction_lv1;
